    ...
    for id, original_string in template:
        if original_string in dictionary:
            ...
            if original_string[0]==' ' and translation[0]!=' ' and translation[0]!=',':
                ...
                print("Warning: a translation of the '%s' string possibly missing the leading space." % original_string)
            if original_string[-1]==' ' and translation[-1]!=' ':
                # translation = translation+' '
                print("Warning: a translation of the '%s' string possibly missing the trailing space." % original_string)
